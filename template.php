 ...
 */
function bibliomega_css_alter(&$css) {
 ...
 * @return Stringp
 */
function bibliomega_date_part_label_date($vars) {
...
function bibliomega_form_alter(&$form, &$form_state, $form_id) {
  switch ($form_id) {
 ...
 */
function bibliomega_breadcrumb($variables) {
...
function bibliomega_links__library_menu(&$variables) {
